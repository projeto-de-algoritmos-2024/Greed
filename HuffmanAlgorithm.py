...
class HuffmanViewer:
    def __init__(self, root):
        ...
        # Instância da lógica do algoritmo
        self.huffman = HuffmanAlgorithm()
    ...
    def build_tree(self):
        ...
        if not text:
            messagebox.showerror("Erro", "Coloque algum texto.")
            return

        self.nodes = self.huffman.build_tree(text)
        self.current_step = 1
    ...
    def update_visualization(self):
        ...
        self.step_label.config(text=f"Etapa: {self.current_step + 1}/{len(self.nodes)}")
